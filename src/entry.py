...
eligiblelist = [
    ...
    [
        "I have diabetes, blood pressure, asthma, HIV/hepatitis B/C infection or I am on dialysis. Can I take the vaccine?"
    ],
    [
        "I have allergies like dust allergy, pollen allergy, seasonal asthma, allergic rhinitis etc. Is it advisable to take the vaccine?"
    ],
    ["🔙"],
]
genquerylist = [
...
postvacquery = [
    ...
    [
        "I have been vaccinated in the last 2-3 days. Now I am getting fever, body ache, headache or weakness. What should I do?"
    ],
    [
        "I have taken the vaccine. How do I ascertain that it has worked? When can I get an antibody test?"
    ],
...
femalequery = [
    ...
    ["general vaccination related queries."],
]
mainmenuquery = [
    ["Queries regarding vaccine eligibility/other pre-vaccination queries"],
...
flow = {
    ...
    "Under 18": [
        "Not eligibile for vaccination now. \n\nSend /start to start over",
        [[]],
    ],
    "Above 18": ["Select your gender", [["Male", "Female"]]],
    "Male": [
